 ...
 */
public class CerrarHojaSeguimientoZikaTask extends UserTask<Object, Void, ErrorDTO> {

    private final Object mLock = new Object();
    private SeguimientoZikaActivity seguimientoZikaActivity;
    private ProgressDialog PD;

    public CerrarHojaSeguimientoZikaTask(SeguimientoZikaActivity seguimientoZikaActivity) {
    ...
    public ErrorDTO doInBackground(Object... params) {
        ...
        if (netInfo != null && netInfo.isConnected()) {
            ...
            resultado = zikaWS.guardarHojaSeguimiento(hojaZika, hojaZika.getLstSeguimientoZika());
        } else {
    ...
    public void onPostExecute(ErrorDTO respuesta) {
        ...
        if (respuesta.getCodigoError().intValue() == 0) {
            MensajesHelper.mostrarMensajeInfo(this.seguimientoZikaActivity,
                    "Hoja de Seguimiento para Casos A, B y D Cerrada.", this.seguimientoZikaActivity.getResources().getString(
