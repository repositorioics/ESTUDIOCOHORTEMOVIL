...
/**
 * Created by MiguelLopez on 14/10/2015.
 */
public class CerrarHojaSeguimientoTask extends UserTask<Object, Void, ErrorDTO> {

    private final Object mLock = new Object();
    private SeguimientoInfluenzaActivity seguimientoInfluenzaActivity;
    private ProgressDialog PD;

    public CerrarHojaSeguimientoTask(SeguimientoInfluenzaActivity seguimientoInfluenzaActivity) {
    ...
    public ErrorDTO doInBackground(Object... params) {
        ...
        if (netInfo != null && netInfo.isConnected()) {
            ...
            String consultorio = (String) params[2];
    ...
    public void onPostExecute(ErrorDTO respuesta) {
        ...
        if (respuesta.getCodigoError().intValue() == 0) {
            MensajesHelper.mostrarMensajeInfo(this.seguimientoInfluenzaActivity,
                    "Hoja de Seguimiento Influenza Cerrada.", this.seguimientoInfluenzaActivity.getResources().getString(
