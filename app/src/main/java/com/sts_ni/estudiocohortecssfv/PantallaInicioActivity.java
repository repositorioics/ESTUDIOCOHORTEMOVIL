...
/***
 * Controlador de la UI de la pantalla incial donde se muestra el saludo al usuario.
 */
public class PantallaInicioActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SEGURIDAD_WS = new SeguridadWS(this);
    ...
    /***************** Esta funcion es utilizada por el adaptador del listivew ****************/
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.pantalla_inicio_layout, container, false);
            TextView txtvNomUsuario = (TextView) rootView.findViewById(R.id.txtvNomUsuario);
            txtvNomUsuario.setText(((CssfvApp)getActivity().getApplication()).getInfoSessionWSDTO().getNameUser());
            return rootView;
        }
        ...
        public void onAttach(Activity activity) {
            ...
            ((PantallaInicioActivity) activity).onSectionAttached(
